  ...
  // ── 메모리 / 타입 시스템 ────────────────────────────────
  {
    ...
    items: [
      ...
      },
      {
        ...
        detail: [
          "int i = 42; object o = i; // 박싱 — 힙에 42 복사",
          "ArrayList, object 파라미터에 int 넘길 때 암묵적으로 발생",
          "힙 할당 + GC 부담 → 성능 민감한 곳에서 주의",
          "제네릭(List<int>)으로 대체하면 박싱 없음",
        ],
      },
      {
        term: "언박싱 (Unboxing)",
        ...
        detail: [
          "object o = 42; int i = (int)o; // 언박싱",
          "박싱된 타입과 정확히 일치해야 함 — (long)o는 예외 발생",
          "언박싱도 힙 접근 비용 발생. 박싱/언박싱 쌍이 많으면 제네릭으로 교체",
        ],
      },
      {
        term: "스택 vs 힙",
